...
function GSingleProduct() {
    ...
    const {cartItems, getItemQty , increaseCartQty , decreaseCartQty} = useShopingCart()
    useEffect(() => {
                ...
                <div className="items-center flex flex-wrap">
                    ...
                    <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div className="md:pr-12">
                            ...
                            {/*cart buttons */}
                            <div className="flex items-center w-full mx-auto my-7 justify-start">
                                ...
                                {getItemQty(product[0].id) > 0 && (
                                    <div className={"flex justify-end ml-14"}>
                                        <h6
                                            ...
                                            {(product[0].prix_vendre * getItemQty(product[0].id)).toFixed(2)}</h6>
                                    </div>
                                )}
                            </div>
                            {/*cart items*/}
                            <div className={"flex items-center gap-3 "}>
                                <div className={""}>
                                    <Button variant=""
                                            className="flex items-center pl-16 bg-green-500 hover:bg-green-800 gap-3 w-52">
                                        Go to Cart
                                ...
                                <div className={""}>
                                    <Button variant=""
                                            className="flex items-center pl-12 bg-red-500 hover:bg-red-900 gap-3 w-56">
                                        Add to Favourite

                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 512 512" fill={"white"} height={"20"}>
                                            <path
