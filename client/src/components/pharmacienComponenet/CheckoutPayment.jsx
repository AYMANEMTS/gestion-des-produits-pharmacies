        ...
        <>
            <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                ...
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-2 relative">
                    ...
                    <div className="grid grid-cols-1">
                        <div className=" ">
                            <input type="text" id="address" name="address"
                                   className="w-full rounded-md border border-gray-200 px-2 py-3 pl-2 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="Address"/>
                        </div>
                    </div>
                ...
                <button className="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Confirm
                    Payment
                </button>
            </div>
        </>
