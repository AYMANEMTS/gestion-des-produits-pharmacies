...
function DefaultUsersTable({data,handleOpen,setFormContext,handleDeleteUser}) {
    return (
                                ...
                                <tr key={index}>
                                    ...
                                    <td className={classes}>
                                        <Tooltip  content="Edit">
                                            <IconButton onClick={() => {
                                                if (type === 'client'){
                                                    setFormContext({formType:"editClient",formData:user})
                                                    handleOpen()
                                                }else if (type === 'admin') {
                                        ...
                                        <Tooltip  content="Detail" >
                                            <IconButton onClick={() => {
                                                if (type === 'client'){
                                                    setFormContext({formType:"readClient",formData:user})
                                                    handleOpen()
                                                }else if (type === 'admin') {
                                        ...
                                        <Tooltip content="Delete">
                                            <IconButton onClick={() => handleDeleteUser(user.id,type)}
...
export default DefaultUsersTable;